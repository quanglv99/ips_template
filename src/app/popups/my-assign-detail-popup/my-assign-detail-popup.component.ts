...
export class MyAssignDetailPopupComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public data: MyWorkModel, private dialogRef: MatDialogRef<MyAssignDetailPopupComponent>) {}
